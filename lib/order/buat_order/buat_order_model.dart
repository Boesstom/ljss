...
import 'buat_order_widget.dart' show BuatOrderWidget;
import 'package:flutter/material.dart';

class BuatOrderModel extends FlutterFlowModel<BuatOrderWidget> {
  ...
  Stream<List<MdDataShipperRow>>? containerSupabaseStream;
  ...
  Stream<List<MdDataBongkarRow>>? dataBongkarSupabaseStream;
  ...
  Stream<List<MdDataShipperRow>>? dropDownTempatStuffingSupabaseStream;
